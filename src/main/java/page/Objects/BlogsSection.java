...
public class BlogsSection {
	...
	static Logger log = Logger.getLogger(BlogsSection.class.getName());
	...
	public void verify_blog6_btn() throws InterruptedException {
		...
		String actual_url = driver.getCurrentUrl();
		Assert.assertEquals(actual_url,
				"https://go.vdotok.com/blog/why-you-need-to-be-part-of-the-real-time-communication-revolution");
		log.info(
				"user is navigated to the CUSTOMER SUPPOERT page on clicking the influencer marketing button in blog-6");
	}
	...
	@FindBy(xpath = "//div[@id=\"root\"]//div[@id=\"documentation\"]//div[2]//div//ul[@class=\"splide__pagination splide__pagination--ltr\"]//li[3]//button")
	WebElement blog_sec_yellowDot3;
	@FindBy(xpath = "//div[@id=\"root\"]//div[@id=\"documentation\"]//div[2]//div//div[2]//ul//li[13]//img")
	...
	// Test Blog7
	@FindBy(xpath = "//div[@id=\"root\"]//div[@id=\"documentation\"]//div[2]//div//div[2]//ul//li[13]//button")
	WebElement blog7_btn;
	@FindBy(xpath = "//div[@id=\"root\"]//div[@id=\"documentation\"]//div[2]//div//div[2]//ul//li[13]//p")
