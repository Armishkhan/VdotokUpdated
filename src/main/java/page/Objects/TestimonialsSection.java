...
public class TestimonialsSection {
	...
	public void verify_testimonial_card1_txt()
	{
		...
		log.info("Company description-1 is displayed in card-1 of testimonials section and matches with the expected text ");
		...
		log.info("Company description-2 is displayed in card-1 of testimonials section and matches with the expected text ");
	}
	...
	public void verify_testimonial_card2_txt()
	{
	   ...
	   log.info("Company description-1 is displayed in card-2 of testimonials section and matches with the expected text ");
	   ...
	   log.info("Company description-2 is displayed in card-2 of testimonials section and matches with the expected text ");
	}	
